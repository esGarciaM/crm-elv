...
import sponsorStatusRoutes from './routes/sponsor-statuses.js';
import logisticsRoutes from './routes/logistics.js';
import decoracionesRoutes from './routes/decoraciones.js';
...
app.use('/api/sponsor-statuses', sponsorStatusRoutes);
